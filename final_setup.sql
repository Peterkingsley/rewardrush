-- Final Corrected Database Setup Script for RewardRush
...
CREATE SEQUENCE public.affiliate_clicks_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.conversions_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.education_categories_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.education_content_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.quest_questions_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
CREATE SEQUENCE public.user_quests_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
-- Data for Name: affiliate_programs;
INSERT INTO public.affiliate_programs (id, category, title, guidelines, details, pros, cons, payout, destination_url) VALUES
...
-- Data for Name: education_categories;
...
-- Data for Name: education_content;
INSERT INTO public.education_content (id, category_id, content_id, title, type, source, author, summary) VALUES
...
INSERT INTO public.products (id, name, tools, brands, regulations, competitors, uniqueness) VALUES
...
-- Data for Name: quest_questions;
INSERT INTO public.quest_questions (id, quest_id, question_id, question_type, question_text, options, correct_answer) VALUES
(1, 1, 'q1', 'multiple-choice', 'What’s the daily trading volume of Bitcoin?', '["$10 billion", "$20 billion", "$30 billion", "$40 billion"]', '$30 billion'),
(2, 1, 'q2', 'open-ended', 'Who founded Ethereum?', NULL, NULL),
...
(4, 2, 'q2', 'open-ended', 'Which brand sponsors eSports the most?', NULL, NULL),
...
(6, 3, 'q2', 'open-ended', 'Name a leading fintech app.', NULL, NULL),
...
(8, 4, 'q2', 'open-ended', 'What’s the main benefit of decentralization?', NULL, NULL),
(9, 5, 'q1', 'multiple-choice', 'Which game has the biggest eSports prize pool?', '["Dota 2", "Fortnite", "CS:GO", "League of Legends"]', 'Dota 2'),
(10, 5, 'q2', 'open-ended', 'Name a top eSports team.', NULL, NULL),
...
(12, 6, 'q2', 'open-ended', 'What’s the most expensive NFT sold?', NULL, NULL),
...
(14, 7, 'q2', 'open-ended', 'Name a popular DeFi platform.', NULL, NULL),
...
(16, 8, 'q2', 'open-ended', 'Which engine powers most mobile games?', NULL, NULL),
...
(18, 9, 'q2', 'open-ended', 'Name a popular crypto wallet app.', NULL, NULL),
(19, 10, 'q1', 'multiple-choice', 'What’s the best VR headset of 2025?', '["Meta Quest 3", "Valve Index", "PSVR 2", "HTC Vive Pro"]', 'Meta Quest 3'),
(20, 10, 'q2', 'open-ended', 'Which game popularized VR gaming?', NULL, NULL);

-- Data for Name: quests;
INSERT INTO public.quests (id, title, description, reward, status, start_time, end_time, participants) VALUES
...
-- Data for Name: users;
INSERT INTO public.users (id, username, email, password_hash, full_name, avatar, points, blocked, twitter_handle, wallet_address, referral_code, reset_password_token, reset_password_expires, last_login, login_streak, created_at) VALUES
(1, 'Royalnoble', 'peterkingslayer098@gmail.com', '$2b$10$4bKKSOe5SXFtjfYsF3qqYeVMpsQqXElrCXiVg5wrCFgrXECC3i2cS', NULL, NULL, 70, false, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2025-06-18 01:59:41.07094+01'),
(2, 'eshiet', 'thecircumfriends@gmail.com', '$2b$10$ee/Z7CjS1W9cXIDXDpQO7O1ICdljIEp.OFENlpWqMGQuSTNtwNpyG', NULL, NULL, 0, false, NULL, NULL, NULL, NULL, NULL, '2025-06-18 02:00:22.797309+01', 1, '2025-06-18 01:59:41.550402+01');
...
-- Add Constraints
ALTER TABLE ONLY public.affiliate_clicks ADD CONSTRAINT affiliate_clicks_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.affiliate_programs ADD CONSTRAINT affiliate_programs_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.education_categories ADD CONSTRAINT education_categories_name_key UNIQUE (name);
ALTER TABLE ONLY public.education_categories ADD CONSTRAINT education_categories_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.education_content ADD CONSTRAINT education_content_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.products ADD CONSTRAINT products_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.professionals ADD CONSTRAINT professionals_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.quest_questions ADD CONSTRAINT quest_questions_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.quests ADD CONSTRAINT quests_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.user_quests ADD CONSTRAINT user_quests_pkey PRIMARY KEY (id);
ALTER TABLE ONLY public.user_quests ADD CONSTRAINT user_quests_user_id_quest_id_key UNIQUE (user_id, quest_id);
...
ALTER TABLE ONLY public.users ADD CONSTRAINT users_wallet_address_key UNIQUE (wallet_address);
ALTER TABLE ONLY public.affiliate_clicks ADD CONSTRAINT affiliate_clicks_program_id_fkey FOREIGN KEY (program_id) REFERENCES public.affiliate_programs(id);
ALTER TABLE ONLY public.bookings ADD CONSTRAINT bookings_professional_id_fkey FOREIGN KEY (professional_id) REFERENCES public.professionals(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.conversions ADD CONSTRAINT conversions_program_id_fkey FOREIGN KEY (program_id) REFERENCES public.affiliate_programs(id);
ALTER TABLE ONLY public.education_content ADD CONSTRAINT education_content_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.education_categories(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.quest_questions ADD CONSTRAINT quest_questions_quest_id_fkey FOREIGN KEY (quest_id) REFERENCES public.quests(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.user_quests ADD CONSTRAINT user_quests_quest_id_fkey FOREIGN KEY (quest_id) REFERENCES public.quests(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.user_quests ADD CONSTRAINT user_quests_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
